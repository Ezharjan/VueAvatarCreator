<template>
    <main>
        <section class="avatar-box">
            <div class="noImage upload-box" v-show="!hasImage">
                <div class="upload-box">
                    <svg viewBox="0 0 512 512.00099" xmlns="http://www.w3.org/2000/svg">
                        <path
        ...
        <button v-show="!hasImage" @click="$refs.picker.click()" class="save-btn">选择图片</button>

        <section class="save-box" v-show="hasImage">
            <button @click="$refs.picker.click()" class="save-btn save-w50">更换头像</button>
            <button @click="saveImage" class="save-btn save-w50">保存图片</button>
        </section>
